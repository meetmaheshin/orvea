...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-gray-900 text-white">
      {/* Newsletter Section */}
      <div className="bg-gradient-to-r from-teal to-teal-dark py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
              ...
              <button
                type="submit"
                className="bg-white text-teal px-8 py-3 rounded-lg font-semibold hover:bg-teal-dark hover:text-white transition-all duration-300"
              >
                Subscribe
              </button>
            </form>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold text-teal mb-4">ORVÉA Estates</h3>
            <p className="text-gray-400 mb-4">
              Your trusted real estate partner, making property transactions seamless and transparent.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-teal transition-all duration-300">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-teal">Quick Links</h4>
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-gray-400 hover:text-teal transition-all duration-300 text-left"
                >
                  Home
                </button>
              </li>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-teal">Our Services</h4>
            <ul className="space-y-2">
              <li>
                <button
                  onClick={() => scrollToSection('properties')}
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-teal">Contact Us</h4>
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start group">
                ...
                <a href="tel:+919911114978" className="hover:text-teal transition-all duration-300">+91 99111 14978</a>
              </li>
              <li className="flex items-start group">
                <svg className="w-5 h-5 mr-2 mt-1 flex-shrink-0 text-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p className="mb-2">
            &copy; ORVÉA India Pvt Ltd. All rights reserved. | {' '}
